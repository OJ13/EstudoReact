...
function loadDescriptor(descriptor, skipOptions) {
  if (typeof descriptor.value !== "function") return { value: descriptor.value, descriptor: descriptor };
...
function loadPluginDescriptor(descriptor) {
  if (descriptor.value instanceof _plugin2.default) return [descriptor.value, descriptor.options];
...
function instantiatePlugin(_ref2) {
  var pluginObject = _ref2.value,
      descriptor = _ref2.descriptor;

  Object.keys(pluginObject).forEach(function (key) {
  ...
  var plugin = Object.assign({}, pluginObject, {
    visitor: (0, _clone2.default)(pluginObject.visitor || {})
  });
